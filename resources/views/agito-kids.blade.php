...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Agito Kid's</a>
...
<header class="masthead">
    <div class="container">
        <div class="intro-text">
            ...
            <div class="intro-heading text-uppercase">AGITO KID'S</div>
    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <i class="fas fa-shopping-cart fa-stack-1x fa-inverse"></i>
                ...
                <h4 class="service-heading">Cartão de Crédito</h4>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
                    ...
                    <img class="img-fluid" src="img/portfolio/futebol2.jpeg" alt="">
                </a>
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="modal-body">
                            ...
                            <img class="img-fluid d-block mx-auto" src="img/portfolio/futebol2.jpeg" alt="">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate,
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="modal-body">
                            ...
                            <h2 class="text-uppercase">Project Name</h2>
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-fluid d-block mx-auto" src="img/portfolio/castelinho.jpeg" alt="">
                            <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate,
                                maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                            <ul class="list-inline">
                                <li>Date: January 2017</li>
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="modal-body">
                            ...
                            <h2 class="text-uppercase">Project Name</h2>
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-fluid d-block mx-auto" src="img/portfolio/castelinho2.jpeg" alt="">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate,
                                maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                            <ul class="list-inline">
                                <li>Date: January 2017</li>
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="modal-body">
                            ...
                            <h2 class="text-uppercase">Project Name</h2>
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-fluid d-block mx-auto" src="img/portfolio/pulapula.jpeg" alt="">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate,
                                maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                            <ul class="list-inline">
                                <li>Date: January 2017</li>
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="modal-body">
                            ...
                            <h2 class="text-uppercase">Project Name</h2>
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-fluid d-block mx-auto" src="img/portfolio/escorrega2.jpeg" alt="">
                            <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate,
                                maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                            <ul class="list-inline">
                                <li>Date: January 2017</li>
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="modal-body">
                            ...
                            <h2 class="text-uppercase">Project Name</h2>
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-fluid d-block mx-auto" src="img/portfolio/contonete.jpeg" alt="">
